...
public class TechnologyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.fragment_technology, container, false);
        fetched_data = false;
        mRecyclerView = v.findViewById(R.id.tech_cards);
        ...
        Runnable procRun = new Runnable() {
            ...
            public void run() {
                if(fetched_data){
                    ...
                    v.findViewById(R.id.progressBar_tech).setVisibility(View.GONE);
                    v.findViewById(R.id.progressText_tech).setVisibility(View.GONE);
                } else{
        ...
        mSwipeRefreshLayout = v.findViewById(R.id.swiperefresh_tech);
    ...
    private void tech_parse_JSON(){
        //String url = "http://jmparekhhw8.us-east-1.elasticbeanstalk.com/guardian/technology";
        String url = "https://hw9backend-275518.ue.r.appspot.com/guardian/technology";
