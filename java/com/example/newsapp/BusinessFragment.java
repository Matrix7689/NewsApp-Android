...
public class BusinessFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.fragment_business, container, false);
        fetched_data = false;
        mRecyclerView = v.findViewById(R.id.business_cards);
        ...
        Runnable procRun = new Runnable() {
            ...
            public void run() {
                if(fetched_data){
                    ...
                    v.findViewById(R.id.progressBar_business).setVisibility(View.GONE);
                    v.findViewById(R.id.progressText_business).setVisibility(View.GONE);
                } else{
    ...
    private void business_parse_JSON(){
        //String url = "http://jmparekhhw8.us-east-1.elasticbeanstalk.com/guardian/business";
        String url = "https://hw9backend-275518.ue.r.appspot.com/guardian/business";
