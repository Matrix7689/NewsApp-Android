...
public class ScienceFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.fragment_science, container, false);
        fetched_data = false;
        mRecyclerView = v.findViewById(R.id.science_cards);
        ...
        Runnable procRun = new Runnable() {
            ...
            public void run() {
                if(fetched_data){
                    ...
                    v.findViewById(R.id.progressBar_science).setVisibility(View.GONE);
                    v.findViewById(R.id.progressText_science).setVisibility(View.GONE);
                } else{
    ...
    private void science_parse_JSON(){
        //String url = "http://jmparekhhw8.us-east-1.elasticbeanstalk.com/guardian/science";
        String url = "https://hw9backend-275518.ue.r.appspot.com/guardian/science";
