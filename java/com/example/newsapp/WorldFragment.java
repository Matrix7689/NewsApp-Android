...
public class WorldFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //System.out.println("in world frag");
        fetched_data = false;
        mRecyclerView = v.findViewById(R.id.world_cards);
        ...
        Runnable procRun = new Runnable() {
            ...
            public void run() {
                if(fetched_data){
                    ...
                    v.findViewById(R.id.progressBar_world).setVisibility(View.GONE);
                    v.findViewById(R.id.progressText_world).setVisibility(View.GONE);
                } else{
    ...
    private void world_parse_JSON(){
        String url = "https://hw9backend-275518.ue.r.appspot.com/guardian/world";
