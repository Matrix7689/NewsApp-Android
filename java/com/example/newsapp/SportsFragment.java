...
public class SportsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fetched_data = false;
        mRecyclerView = v.findViewById(R.id.sports_cards);
        ...
        Runnable procRun = new Runnable() {
            ...
            public void run() {
                if(fetched_data){
                    ...
                    v.findViewById(R.id.progressBar_sports).setVisibility(View.GONE);
                    v.findViewById(R.id.progressText_sports).setVisibility(View.GONE);
                } else{
    ...
    private void sports_parse_JSON(){
        //String url = "http://jmparekhhw8.us-east-1.elasticbeanstalk.com/guardian/sport";
        String url = "https://hw9backend-275518.ue.r.appspot.com/guardian/sport";
